function [J, fitWhisker, rotWhisker, coefficients] = revision_orthogonalRegression_cubic(whisker, angle_min, angle_max)
%
% By Yifu
% 2022/06/15
...
A0 = whisker(end,2)/whisker(end,1)^3;
...
% fmincon is equivalent to fminsearch with constraints
...
function [J, fitWhisker, rotWhisker] = generateWhiskerCostFunc(coef, whisker)
    ...
    [fitX, fitY] = acoeff2cart_cubic(coef(2), whiskerLength(rotWhisker), numPts);
